  ...
  broadcastState(events) {
    ...
    for (const ws of this.sockets()) {
      ...
      this.sendTo(ws, {
        ...
        /* the same move can look different from different chairs: in Ronda,
           staying quiet about a pair is nobody else's business */
        events: this.E.eventsFor ? this.E.eventsFor(events || [], a.id) : (events || []),
